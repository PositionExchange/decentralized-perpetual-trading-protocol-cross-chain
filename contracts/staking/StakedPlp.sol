...
contract StakedPlp {
    ...
    function transferFrom(
        ...
        uint256 nextAllowance = allowances[_sender][msg.sender].sub(
            _amount,
            "StakedPlp: transfer amount exceeds allowance"
        );
    ...
    function _approve(
        ...
        require(
            _owner != address(0),
            "StakedPlp: approve from the zero address"
        );
        require(
            _spender != address(0),
            "StakedPlp: approve to the zero address"
        );
    ...
    function _transfer(
        ...
        require(
            _sender != address(0),
            "StakedPlp: transfer from the zero address"
        );
        require(
            _recipient != address(0),
            "StakedPlp: transfer to the zero address"
        );
