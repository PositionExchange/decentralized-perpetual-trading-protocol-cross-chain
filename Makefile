...
deploy_testnet_futures_gateway:
	yarn compile
	npx hardhat deploy --network arbitrumGoerli --stage test --task 'deploy futures gateway'
...
deploy_mainnet_futures_gateway:
	npx hardhat compile
	npx hardhat deploy --network arbitrumOne --stage production --task 'deploy futures gateway'
deploy_mainnet_futures_adapter:
	npx hardhat compile
	npx hardhat deploy --network arbitrumOne --stage production --task 'deploy futures adapter'
